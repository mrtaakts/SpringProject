// jquery.repeaterson version 0.1.4
// https://github.com/DubFriend/jquery.repeaterson
// (MIT) 13-08-2014
...
$.fn.repeaterson = function(fig) {
    ...
    var $list = $self.find('[data-repeaterson-list]');

    var $itemTemplate = $list.find('[data-repeaterson-item]')
            .first().clone().hide();

    var groupName = $list.data('repeaterson-list');

    var setIndexes = function () {
        $list.find('[data-repeaterson-item]').each(function (index) {
    ...
    $self.find('[data-repeaterson-create]').click(function () {
        var $item = $itemTemplate.clone();
        appendItem($item);
        show.call($item.get(0));
    });

    $list.on('click', '[data-repeaterson-delete]', function () {
        var self = $(this).closest('[data-repeaterson-item]').get(0);
